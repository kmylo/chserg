...
! function(e, t, n) {
    ...
    u || ! function(e, t) {
        ...
        function i(e, n, r) {
            ...
            r || (r = a(n));
            var o;
            return o = r.cache[e] ? r.cache[e].cloneNode() : _.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !o.canHaveChildren || E.test(e) || o.tagUrn ? o : r.frag.appendChild(o)
        }
        ...
        function l(e) {
            e || (e = t);
            var r = a(e);
            return !S.shivCSS || h || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), v || c(e, r), e
        }
        ...
        function d(e) {
            for (var t, n = e.split("{"), o = n.length, a = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), i = "$1" + w + "\\:$2"; o--;) t = n[o] = n[o].split("}"), t[t.length - 1] = t[t.length - 1].replace(a, i), n[o] = t.join("}");
            return n.join("{")
        }
        ...
        function p(e) {
            ...
            var r, o, i = a(e),
                s = e.namespaces,
                c = e.parentWindow;
            return !C || e.printShived ? e : ("undefined" == typeof s[w] && s.add(w), c.attachEvent("onbeforeprint", function() {
                t();
        ...
        var h, v, g = "3.7.3",
            ...
            _ = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,
            b = "_html5shiv",
            x = 0,
            N = {};
        ! function() {
        ...
        S.type += " print", S.shivPrint = p, p(t), "object" == typeof module && module.exports && (module.exports = S)
    }("undefined" != typeof e ? e : this, t);
    var f = "Moz O ms Webkit",
        d = s._config.usePrefixes ? f.toLowerCase().split(" ") : [];
    s._domPrefixes = d;
    var m;
    ! function() {
        var e = {}.hasOwnProperty;
        m = r(e, "undefined") || r(e.call, "undefined") ? function(e, t) {
